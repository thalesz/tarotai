...
def verify_jwt(request: Request):
    try:
        ...
        print(f"Decoded payload: {payload}")  # Debugging line to check the decoded payload
        ...
        token_info = TokenInfoSchema(**payload)  # Populate TokenInfoSchema with all attributes from the payload

        request.state.token_info = token_info  # Save the information globally in the request
