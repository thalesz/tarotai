...
@router.get(
    "/draw/{draw_id}",
    summary="Retorna avaliação especifica de uma tiragem",
    description="""
Retorna avaliação especifica, caso exista, de uma tiragem.
""",
...
async def get_review_by_draw(
    ...
    try:
        ...
        reviews = await ReviewSchemaBase.get_review_by_draw(db, draw_id, user_id=user_id)
